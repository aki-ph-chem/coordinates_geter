...
input_file_name = "c:/Users/simiz/Desktop/rot_const/dbt_log/DIBENZOTHIOPHENE_MP2_6-31G_PLANER_6_CORE.LOG"

name_of_output_file = "dbt_mp2_6-31G.csv"                           # name of output file name
...
write.table(coordinates_numerical,name_of_output_file,sep = ",",col.name = F,row.name = F)  #コンマ区切り

write.table(coordinates_numerical,name_of_output_file,sep = " ",col.name = F,row.name = F)  #スペース区切り
